...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="25000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{37f1b184-d381-4c01-ace6-b8c713f0d504}">
      ...
      <rule filter="&quot;art_txt&quot; = 'geschlossener_Wald'" key="{9913eb4f-d55e-495a-981f-888a10fe1f13}" label="geschlossener_Wald">
        <rule scalemaxdenom="300" key="{c78f453d-6d09-4a86-89e1-02aa26ea6a6c}" symbol="26" scalemindenom="1" label="1:250"/>
      ...
      <rule filter="&quot;art_txt&quot;  IN ( 'uebrige_bestockte', 'Parkanlage_bestockt','Hecke')" key="{d4a04290-3cb3-4261-b7f5-da6370ebbcd7}" label="uebrige_bestockte">
        <rule scalemaxdenom="300" key="{4203e22e-d88f-4556-85df-2747e11a5ac9}" symbol="31" scalemindenom="300" label="1:250"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="10">
        <layer pass="1" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="233,230,233,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@25@0">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v=""/>
              <prop k="offset" v="-0.82828282828200006,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="0,0,0,255"/>
              <prop k="outline_width" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="36">
        <layer pass="0" class="SVGFill" locked="0">
          ...
          <prop k="svgFile" v="symbols/symbol_1_fels_geroell_param.svg"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="41">
        <layer pass="0" class="SVGFill" locked="0">
          ...
          <prop k="pattern_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="pattern_width_unit" v="MM"/>
          <prop k="svgFile" v="symbols/symbol_2_geroell_param.svg"/>
          <prop k="svg_outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="svg_outline_width_unit" v="MM"/>
          <prop k="width" v="2.8"/>
  ...
  <customproperties>
    ...
    <property key="labeling/scaleMax" value="18282820"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;art_txt&quot;" sortOrder="0">
    <columns>
      <column width="315" hidden="0" type="field" name="art_txt"/>
