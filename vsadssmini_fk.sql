...
CREATE TABLE vsadssmini_fk.vsadssmini_sk (
  T_Id bigint PRIMARY KEY DEFAULT nextval('vsadssmini_fk.t_ili2db_seq')
...
;
CREATE INDEX vsadssmini_sk_bueroref_idx ON vsadssmini_fk.vsadssmini_sk ( bueroref );
CREATE INDEX vsadssmini_sk_hauptbauwerkref_idx ON vsadssmini_fk.vsadssmini_sk ( hauptbauwerkref );
CREATE INDEX vsadssmini_sk_naechstes_sbwref_idx ON vsadssmini_fk.vsadssmini_sk ( naechstes_sbwref );
CREATE INDEX vsadssmini_sk_paa_knotenref_idx ON vsadssmini_fk.vsadssmini_sk ( paa_knotenref );
CREATE INDEX vsadssmini_sk_standortgemeinderef_idx ON vsadssmini_fk.vsadssmini_sk ( standortgemeinderef );
CREATE INDEX vsadssmini_sk_datenherrref_idx ON vsadssmini_fk.vsadssmini_sk ( datenherrref );
CREATE INDEX vsadssmini_sk_datenlieferantref_idx ON vsadssmini_fk.vsadssmini_sk ( datenlieferantref );
CREATE INDEX vsadssmini_sk_ausfuehrende_firmaref_idx ON vsadssmini_fk.vsadssmini_sk ( ausfuehrende_firmaref );
CREATE INDEX vsadssmini_sk_einleitstelleref_idx ON vsadssmini_fk.vsadssmini_sk ( einleitstelleref );
CREATE INDEX vsadssmini_sk_einleitstelleref1_idx ON vsadssmini_fk.vsadssmini_sk ( einleitstelleref1 );
CREATE INDEX vsadssmini_sk_primaerrichtungref_idx ON vsadssmini_fk.vsadssmini_sk ( primaerrichtungref );
...
CREATE INDEX vsadssmini_teileinzgsgbiet_sbw_rw_istref_idx ON vsadssmini_fk.vsadssmini_teileinzugsgebiet ( sbw_rw_istref );
CREATE INDEX vsadssmini_teileinzgsgbiet_sbw_rw_geplantref_idx ON vsadssmini_fk.vsadssmini_teileinzugsgebiet ( sbw_rw_geplantref );
CREATE INDEX vsadssmini_teileinzgsgbiet_sbw_sw_istref_idx ON vsadssmini_fk.vsadssmini_teileinzugsgebiet ( sbw_sw_istref );
CREATE INDEX vsadssmini_teileinzgsgbiet_sbw_sw_geplantref_idx ON vsadssmini_fk.vsadssmini_teileinzugsgebiet ( sbw_sw_geplantref );
...
CREATE INDEX vsadssmini_bauwerkskmpnnte_stammkarteref_idx ON vsadssmini_fk.vsadssmini_bauwerkskomponente ( stammkarteref );
...
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_wbw_basisjahr_check CHECK( wbw_basisjahr BETWEEN 1800 AND 2100);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_wiederbeschaffungswert_check CHECK( wiederbeschaffungswert BETWEEN 0.0 AND 9.999999999E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_bueroref_fkey FOREIGN KEY ( bueroref ) REFERENCES vsadssmini_fk.administration_organisation DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_hauptbauwerkref_fkey FOREIGN KEY ( hauptbauwerkref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_naechstes_sbwref_fkey FOREIGN KEY ( naechstes_sbwref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_paa_knotenref_fkey FOREIGN KEY ( paa_knotenref ) REFERENCES vsadssmini_fk.vsadssmini_knoten DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_standortgemeinderef_fkey FOREIGN KEY ( standortgemeinderef ) REFERENCES vsadssmini_fk.administration_organisation DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_datenherrref_fkey FOREIGN KEY ( datenherrref ) REFERENCES vsadssmini_fk.administration_organisation DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_datenlieferantref_fkey FOREIGN KEY ( datenlieferantref ) REFERENCES vsadssmini_fk.administration_organisation DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_auslaufrohr_lichte_hoehe_check CHECK( auslaufrohr_lichte_hoehe BETWEEN 0 AND 99999);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_gewssrspzfsc_nh4_n_gplant_check CHECK( gewaesserspezifische_entlastungsfracht_nh4_n_geplant BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_gewssrspzfsccht_nh4_n_ist_check CHECK( gewaesserspezifische_entlastungsfracht_nh4_n_ist BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_gewssrspzfsc_nh4_n_ptmert_check CHECK( gewaesserspezifische_entlastungsfracht_nh4_n_optimiert BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_q347_check CHECK( q347 BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_relevantes_gefaelle_check CHECK( relevantes_gefaelle BETWEEN 0 AND 1000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_wasserspiegel_hydraulik_check CHECK( wasserspiegel_hydraulik BETWEEN -200.0 AND 5000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ausfuehrende_firmaref_fkey FOREIGN KEY ( ausfuehrende_firmaref ) REFERENCES vsadssmini_fk.administration_organisation DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_aggregatezahl_check CHECK( aggregatezahl BETWEEN 1 AND 9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_geplant_check CHECK( einwohner_dim_geplant BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_ist_check CHECK( einwohner_dim_ist BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_geplant_check CHECK( flaeche_bef_dim_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_ist_check CHECK( flaeche_bef_dim_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_geplant_check CHECK( flaeche_dim_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_ist_check CHECK( flaeche_dim_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_geplant_check CHECK( flaeche_red_dim_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_ist_check CHECK( flaeche_red_dim_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_foerderhoehe_geodaetisch_check CHECK( foerderhoehe_geodaetisch BETWEEN 0.0 AND 30000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_foerderstrommax_check CHECK( foerderstrommax BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_foerderstrommin_check CHECK( foerderstrommin BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_geplant_check CHECK( fremdwasseranfall_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_ist_check CHECK( fremdwasseranfall_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwassrnfll_gplant_check CHECK( schmutzabwasseranfall_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwasseranfall_ist_check CHECK( schmutzabwasseranfall_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_stauraum_check CHECK( stauraum BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_volumen_pumpensumpf_check CHECK( volumen_pumpensumpf BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_geplant_check CHECK( einwohner_geplant BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_ist_check CHECK( einwohner_ist BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsntl_nh4_n_gplant_check CHECK( entlastungsanteil_nh4_n_geplant BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlastungsantl_nh4_n_ist_check CHECK( entlastungsanteil_nh4_n_ist BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsntl_nh4_n_ptmert_check CHECK( entlastungsanteil_nh4_n_optimiert BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsfrc_nh4_n_gplant_check CHECK( entlastungsfracht_nh4_n_geplant BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlastngsfrcht_nh4_n_ist_check CHECK( entlastungsfracht_nh4_n_ist BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsfrc_nh4_n_ptmert_check CHECK( entlastungsfracht_nh4_n_optimiert BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_geplant_check CHECK( flaeche_bef_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_ist_check CHECK( flaeche_bef_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_geplant_check CHECK( flaeche_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_ist_check CHECK( flaeche_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_geplant_check CHECK( flaeche_red_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_ist_check CHECK( flaeche_red_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_geplnt1_check CHECK( fremdwasseranfall_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_ist1_check CHECK( fremdwasseranfall_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_geplant_check CHECK( mehrbelastung_geplant BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist_check CHECK( mehrbelastung_ist BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist_optmert_check CHECK( mehrbelastung_ist_optimiert BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_geplant_check CHECK( qan_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist_check CHECK( qan_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist_optimiert_check CHECK( qan_ist_optimiert BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwassrnfll_gplnt1_check CHECK( schmutzabwasseranfall_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwasseranfall_st1_check CHECK( schmutzabwasseranfall_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_stauraum1_check CHECK( stauraum1 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_geplant_check CHECK( ueberlaufdauer_geplant BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_ist_check CHECK( ueberlaufdauer_ist BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_ist_ptmert_check CHECK( ueberlaufdauer_ist_optimiert BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhaeufigkt_gplant_check CHECK( ueberlaufhaeufigkeit_geplant BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhaeufigkeit_ist_check CHECK( ueberlaufhaeufigkeit_ist BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhafgkt_st_ptmert_check CHECK( ueberlaufhaeufigkeit_ist_optimiert BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_geplant_check CHECK( ueberlaufmenge_geplant BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_ist_check CHECK( ueberlaufmenge_ist BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_ist_ptmert_check CHECK( ueberlaufmenge_ist_optimiert BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einleitstelleref_fkey FOREIGN KEY ( einleitstelleref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_geplant1_check CHECK( einwohner_dim_geplant1 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_ist1_check CHECK( einwohner_dim_ist1 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_geplant1_check CHECK( einwohner_geplant1 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_ist1_check CHECK( einwohner_ist1 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsntl_nh4_n_gplnt1_check CHECK( entlastungsanteil_nh4_n_geplant1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlastungsantl_nh4_n_st1_check CHECK( entlastungsanteil_nh4_n_ist1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsntl_nh4_n_ptmrt1_check CHECK( entlastungsanteil_nh4_n_optimiert1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsfrc_nh4_n_gplnt1_check CHECK( entlastungsfracht_nh4_n_geplant1 BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlastngsfrcht_nh4_n_st1_check CHECK( entlastungsfracht_nh4_n_ist1 BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_entlstngsfrc_nh4_n_ptmrt1_check CHECK( entlastungsfracht_nh4_n_optimiert1 BETWEEN 0 AND 1000000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_geplant1_check CHECK( flaeche_bef_dim_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_ist1_check CHECK( flaeche_bef_dim_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_geplant1_check CHECK( flaeche_bef_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_ist1_check CHECK( flaeche_bef_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_geplant1_check CHECK( flaeche_dim_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_ist1_check CHECK( flaeche_dim_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_geplant1_check CHECK( flaeche_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_ist1_check CHECK( flaeche_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_geplant1_check CHECK( flaeche_red_dim_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_ist1_check CHECK( flaeche_red_dim_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_geplant1_check CHECK( flaeche_red_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_ist1_check CHECK( flaeche_red_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_geplnt2_check CHECK( fremdwasseranfall_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_ist2_check CHECK( fremdwasseranfall_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_geplant1_check CHECK( mehrbelastung_geplant1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist1_check CHECK( mehrbelastung_ist1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist_optmrt1_check CHECK( mehrbelastung_ist_optimiert1 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_nutzinhalt_fangteil_check CHECK( nutzinhalt_fangteil BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_nutzinhalt_klaerteil_check CHECK( nutzinhalt_klaerteil BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_geplant1_check CHECK( qan_geplant1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist1_check CHECK( qan_ist1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist_optimiert1_check CHECK( qan_ist_optimiert1 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwassrnfll_gplnt2_check CHECK( schmutzabwasseranfall_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwasseranfall_st2_check CHECK( schmutzabwasseranfall_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_stauraum2_check CHECK( stauraum2 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_geplant1_check CHECK( ueberlaufdauer_geplant1 BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_ist1_check CHECK( ueberlaufdauer_ist1 BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufdauer_ist_ptmrt1_check CHECK( ueberlaufdauer_ist_optimiert1 BETWEEN 0.0 AND 10000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhaeufigkt_gplnt1_check CHECK( ueberlaufhaeufigkeit_geplant1 BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhaeufigkeit_ist1_check CHECK( ueberlaufhaeufigkeit_ist1 BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufhafgkt_st_ptmrt1_check CHECK( ueberlaufhaeufigkeit_ist_optimiert1 BETWEEN 0.0 AND 999.9);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_geplant1_check CHECK( ueberlaufmenge_geplant1 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_ist1_check CHECK( ueberlaufmenge_ist1 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_ueberlaufmenge_ist_ptmrt1_check CHECK( ueberlaufmenge_ist_optimiert1 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einleitstelleref1_fkey FOREIGN KEY ( einleitstelleref1 ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_geplant2_check CHECK( einwohner_dim_geplant2 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_einwohner_dim_ist2_check CHECK( einwohner_dim_ist2 BETWEEN 0 AND 300000);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_geplant2_check CHECK( flaeche_bef_dim_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_bef_dim_ist2_check CHECK( flaeche_bef_dim_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_geplant2_check CHECK( flaeche_dim_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_dim_ist2_check CHECK( flaeche_dim_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_geplant2_check CHECK( flaeche_red_dim_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_flaeche_red_dim_ist2_check CHECK( flaeche_red_dim_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_geplnt3_check CHECK( fremdwasseranfall_geplant3 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_fremdwasseranfall_ist3_check CHECK( fremdwasseranfall_ist3 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_nutzinhalt_check CHECK( nutzinhalt BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qab_geplant_check CHECK( qab_geplant BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qab_ist_check CHECK( qab_ist BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qab_ist_optimiert_check CHECK( qab_ist_optimiert BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwassrnfll_gplnt3_check CHECK( schmutzabwasseranfall_geplant3 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_schmutzabwasseranfall_st3_check CHECK( schmutzabwasseranfall_ist3 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_stauraum3_check CHECK( stauraum3 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_geplant2_check CHECK( mehrbelastung_geplant2 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist2_check CHECK( mehrbelastung_ist2 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_mehrbelastung_ist_optmrt2_check CHECK( mehrbelastung_ist_optimiert2 BETWEEN 0.0 AND 100.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_geplant2_check CHECK( qan_geplant2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist2_check CHECK( qan_ist2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_qan_ist_optimiert2_check CHECK( qan_ist_optimiert2 BETWEEN 0.0 AND 100000.0);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_stauraum4_check CHECK( stauraum4 BETWEEN 0.0 AND 1.0E7);
ALTER TABLE vsadssmini_fk.vsadssmini_sk ADD CONSTRAINT vsadssmini_sk_primaerrichtungref_fkey FOREIGN KEY ( primaerrichtungref ) REFERENCES vsadssmini_fk.vsadssmini_knoten DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE vsadssmini_fk.vsadssmini_teileinzugsgebiet ADD CONSTRAINT vsadssmini_teileinzgsgbiet_sbw_rw_istref_fkey FOREIGN KEY ( sbw_rw_istref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_teileinzugsgebiet ADD CONSTRAINT vsadssmini_teileinzgsgbiet_sbw_rw_geplantref_fkey FOREIGN KEY ( sbw_rw_geplantref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_teileinzugsgebiet ADD CONSTRAINT vsadssmini_teileinzgsgbiet_sbw_sw_istref_fkey FOREIGN KEY ( sbw_sw_istref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_teileinzugsgebiet ADD CONSTRAINT vsadssmini_teileinzgsgbiet_sbw_sw_geplantref_fkey FOREIGN KEY ( sbw_sw_geplantref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_duekeroberhauptref_fkey FOREIGN KEY ( sk_duekeroberhauptref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_pumpwerkref_fkey FOREIGN KEY ( sk_pumpwerkref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_regenruckhltbckn_knlref_fkey FOREIGN KEY ( sk_regenrueckhaltebecken_kanalref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_regenueberlaufref_fkey FOREIGN KEY ( sk_regenueberlaufref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_regenueberlaufbeckenref_fkey FOREIGN KEY ( sk_regenueberlaufbeckenref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE vsadssmini_fk.vsadssmini_kennlinie_stuetzpunkt ADD CONSTRAINT vsadssmini_kennln_sttzpnkt_sk_trennbauwerkref_fkey FOREIGN KEY ( sk_trennbauwerkref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE vsadssmini_fk.vsadssmini_bauwerkskomponente ADD CONSTRAINT vsadssmini_bauwerkskmpnnte_stammkarteref_fkey FOREIGN KEY ( stammkarteref ) REFERENCES vsadssmini_fk.vsadssmini_sk DEFERRABLE INITIALLY DEFERRED;
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsanteil_NH4_N_Ist','entlastungsanteil_nh4_n_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Einfluss_Wasserpflanzen','einfluss_wasserpflanzen','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_Dim_Ist','flaeche_dim_ist2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Mehrbelastung_Ist','mehrbelastung_ist2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Stauraum','stauraum3','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufhaeufigkeit_Ist','ueberlaufhaeufigkeit_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Einwohner_Dim_Ist','einwohner_dim_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufhaeufigkeit_geplant','ueberlaufhaeufigkeit_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Einwohner_Dim_geplant','einwohner_dim_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Qan_geplant','qan_geplant2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_bef_Dim_geplant','flaeche_bef_dim_geplant2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufhaeufigkeit_geplant','ueberlaufhaeufigkeit_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_bef_Ist','flaeche_bef_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_Dim_geplant','flaeche_dim_geplant2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Fremdwasseranfall_Ist','fremdwasseranfall_ist2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Mehrbelastung_Ist','mehrbelastung_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsanteil_NH4_N_geplant','entlastungsanteil_nh4_n_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Einwohner_geplant','einwohner_geplant','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SIA405_Base_Abwasser_LV95.SIA405_BaseClass.Letzte_Aenderung','letzte_aenderung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Qan_Ist','qan_ist2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Vergleich_letzte_Untersuchung','vergleich_letzte_untersuchung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Mehrbelastung_Ist_optimiert','mehrbelastung_ist_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Teileinzugsgebiet_SBW_RW_geplantAssoc.SBW_RW_geplantRef','sbw_rw_geplantref','vsadssmini_teileinzugsgebiet','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufmenge_geplant','ueberlaufmenge_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_Dim_Ist','flaeche_dim_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_bef_Dim_Ist','flaeche_bef_dim_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Fremdwasseranfall_geplant','fremdwasseranfall_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Naechstes_SBWAssoc.Naechstes_SBWRef','naechstes_sbwref','vsadssmini_sk','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Fremdwasseranfall_geplant','fremdwasseranfall_geplant3','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_StandortgemeindeAssoc.StandortgemeindeRef','standortgemeinderef','vsadssmini_sk','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_red_Ist','flaeche_red_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Gewaesserspezifische_Entlastungsfracht_NH4_N_optimiert','gewaesserspezifische_entlastungsfracht_nh4_n_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Datum_Untersuchung','datum_untersuchung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.relevantes_Gefaelle','relevantes_gefaelle','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_red_Dim_Ist','flaeche_red_dim_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_PumpwerkAssoc.SK_PumpwerkRef','sk_pumpwerkref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsfracht_NH4_N_geplant','entlastungsfracht_nh4_n_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_Ist','flaeche_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Fremdwasseranfall_Ist','fremdwasseranfall_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufmenge_geplant','ueberlaufmenge_geplant','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Qan_Ist_optimiert','qan_ist_optimiert2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Stauraum','stauraum1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Q347','q347','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.FoerderstromMin','foerderstrommin','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Uebrige.Beschrieb','beschrieb','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Qan_Ist','qan_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Gewaesserart','gewaesserart','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Springt_an','springt_an','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_Ist','flaeche_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.OBJ_ID_Biol_oekol_Gesamtbeurteilung','obj_id_biol_oekol_gesamtbeurteilung','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Schmutzabwasseranfall_geplant','schmutzabwasseranfall_geplant2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Gewaesserspezifische_Entlastungsfracht_NH4_N_geplant','gewaesserspezifische_entlastungsfracht_nh4_n_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufmenge_Ist_optimiert','ueberlaufmenge_ist_optimiert1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Fremdwasseranfall_Ist','fremdwasseranfall_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Mehrbelastung_geplant','mehrbelastung_geplant2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Notueberlauf','notueberlauf','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Schmutzabwasseranfall_geplant','schmutzabwasseranfall_geplant3','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Stauraum','stauraum2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.DatenlieferantAssoc.DatenlieferantRef','datenlieferantref','vsadssmini_sk','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Stauraum','stauraum4','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Standortname','standortname','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsfracht_NH4_N_Ist','entlastungsfracht_nh4_n_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Fremdwasseranfall_geplant','fremdwasseranfall_geplant2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken_EinleitstelleAssoc.EinleitstelleRef','einleitstelleref1','vsadssmini_sk','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Qab_Ist_optimiert','qab_ist_optimiert','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufdauer_geplant','ueberlaufdauer_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Nutzinhalt_Klaerteil','nutzinhalt_klaerteil','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Qan_Ist_optimiert','qan_ist_optimiert1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Fremdwasseranfall_Ist','fremdwasseranfall_ist3','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Nutzinhalt_Fangteil','nutzinhalt_fangteil','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsanteil_NH4_N_Ist','entlastungsanteil_nh4_n_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Immissionsorientierte_Berechnung','immissionsorientierte_berechnung','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Bauwerkskomponente_StammkarteAssoc.StammkarteRef','stammkarteref','vsadssmini_bauwerkskomponente','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Qab_Ist','qab_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_red_geplant','flaeche_red_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlauf_Bemerkung','ueberlauf_bemerkung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Sachbearbeiter','sachbearbeiter','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Relevanzmatrix','relevanzmatrix','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Teileinzugsgebiet_SBW_SW_geplantAssoc.SBW_SW_geplantRef','sbw_sw_geplantref','vsadssmini_teileinzugsgebiet','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Schmutzabwasseranfall_Ist','schmutzabwasseranfall_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Mehrbelastung_Ist_optimiert','mehrbelastung_ist_optimiert1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufdauer_Ist_optimiert','ueberlaufdauer_ist_optimiert','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Teileinzugsgebiet_SBW_SW_IstAssoc.SBW_SW_IstRef','sbw_sw_istref','vsadssmini_teileinzugsgebiet','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufmenge_Ist','ueberlaufmenge_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_RegenueberlaufbeckenAssoc.SK_RegenueberlaufbeckenRef','sk_regenueberlaufbeckenref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Qan_geplant','qan_geplant','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_RegenueberlaufAssoc.SK_RegenueberlaufRef','sk_regenueberlaufref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Biol_oekol_Gesamtbeurteilung_Bemerkung','biol_oekol_gesamtbeurteilung_bemerkung','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Wehr_Art','wehr_art','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Einwohner_Dim_geplant','einwohner_dim_geplant2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Einfluss_Makroinvertebraten','einfluss_makroinvertebraten','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.FoerderstromMax','foerderstrommax','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_BueroAssoc.BueroRef','bueroref','vsadssmini_sk','administration_organisation');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Bemerkung','bemerkung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Schmutzabwasseranfall_geplant','schmutzabwasseranfall_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Stauraum','stauraum','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Informationsquelle','informationsquelle','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Art','art','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_geplant','flaeche_geplant1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Einwohner_Dim_Ist','einwohner_dim_ist2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Einfluss_Hilfsindikatoren','einfluss_hilfsindikatoren','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_bef_Dim_geplant','flaeche_bef_dim_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Foerderhoehe_geodaetisch','foerderhoehe_geodaetisch','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_TrennbauwerkAssoc.SK_TrennbauwerkRef','sk_trennbauwerkref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_Regenrueckhaltebecken_kanalAssoc.SK_Regenrueckhaltebecken_kanalRef','sk_regenrueckhaltebecken_kanalref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsanteil_NH4_N_optimiert','entlastungsanteil_nh4_n_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_red_Dim_Ist','flaeche_red_dim_ist2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsanteil_NH4_N_optimiert','entlastungsanteil_nh4_n_optimiert1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Einwohner_Dim_Ist','einwohner_dim_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsanteil_NH4_N_geplant','entlastungsanteil_nh4_n_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Qan_geplant','qan_geplant1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufhaeufigkeit_Ist','ueberlaufhaeufigkeit_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufdauer_geplant','ueberlaufdauer_geplant1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Mehrbelastung_Ist','mehrbelastung_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk_PrimaerrichtungAssoc.PrimaerrichtungRef','primaerrichtungref','vsadssmini_sk','vsadssmini_knoten');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Regenbecken_Anordnung','regenbecken_anordnung1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_Dim_geplant','flaeche_dim_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_bef_Dim_Ist','flaeche_bef_dim_ist2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf_EinleitstelleAssoc.EinleitstelleRef','einleitstelleref','vsadssmini_sk','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Qab_geplant','qab_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Mehrbelastung_geplant','mehrbelastung_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsfracht_NH4_N_Ist','entlastungsfracht_nh4_n_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_bef_Dim_geplant','flaeche_bef_dim_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_bef_geplant','flaeche_bef_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Mehrbelastung_geplant','mehrbelastung_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufhaeufigkeit_Ist_optimiert','ueberlaufhaeufigkeit_ist_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_Dim_geplant','flaeche_dim_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_bef_Ist','flaeche_bef_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Qan_Ist','qan_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_Dim_Ist','flaeche_dim_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlauf_Bemerkung','ueberlauf_bemerkung1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufdauer_Ist','ueberlaufdauer_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_red_Ist','flaeche_red_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufdauer_Ist_optimiert','ueberlaufdauer_ist_optimiert1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Fremdwasseranfall_geplant','fremdwasseranfall_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_red_geplant','flaeche_red_geplant','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt_SK_DuekeroberhauptAssoc.SK_DuekeroberhauptRef','sk_duekeroberhauptref','vsadssmini_kennlinie_stuetzpunkt','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Datum_letzte_Untersuchung','datum_letzte_untersuchung','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Qan_Ist_optimiert','qan_ist_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Foerderaggregat_Nutzungsart_Ist','foerderaggregat_nutzungsart_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Einwohner_Dim_geplant','einwohner_dim_geplant1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Schmutzabwasseranfall_Ist','schmutzabwasseranfall_ist3','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Flaeche_red_Dim_geplant','flaeche_red_dim_geplant2','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal.Nutzinhalt','nutzinhalt','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_red_Dim_geplant','flaeche_red_dim_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.DatenherrAssoc.DatenherrRef','datenherrref','vsadssmini_sk','administration_organisation');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.WBW_Basisjahr','wbw_basisjahr','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufdauer_Ist','ueberlaufdauer_ist','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Flaeche_red_Dim_Ist','flaeche_red_dim_ist1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk.Mehrbelastung_Ist_optimiert','mehrbelastung_ist_optimiert2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_HauptbauwerkAssoc.HauptbauwerkRef','hauptbauwerkref','vsadssmini_sk','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Schmutzabwasseranfall_Ist','schmutzabwasseranfall_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsfracht_NH4_N_geplant','entlastungsfracht_nh4_n_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufmenge_Ist_optimiert','ueberlaufmenge_ist_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_PAA_KnotenAssoc.PAA_KnotenRef','paa_knotenref','vsadssmini_sk','vsadssmini_knoten');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Aggregatezahl','aggregatezahl','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Gewaesserspezifische_Entlastungsfracht_NH4_N_Ist','gewaesserspezifische_entlastungsfracht_nh4_n_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Teileinzugsgebiet_SBW_RW_IstAssoc.SBW_RW_IstRef','sbw_rw_istref','vsadssmini_teileinzugsgebiet','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Ausfuehrender','ausfuehrender','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Schmutzabwasseranfall_geplant','schmutzabwasseranfall_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Auslaufrohr_Lichte_Hoehe','auslaufrohr_lichte_hoehe','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Einwohner_Ist','einwohner_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Ueberlaufmenge_Ist','ueberlaufmenge_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Akten','akten','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Handlungsbedarf','handlungsbedarf','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_red_Dim_geplant','flaeche_red_dim_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Einfluss_Aeusserer_Aspekt','einfluss_aeusserer_aspekt','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle_Ausfuehrende_FirmaAssoc.Ausfuehrende_FirmaRef','ausfuehrende_firmaref','vsadssmini_sk','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_geplant','flaeche_geplant','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Regenbecken_Anordnung','regenbecken_anordnung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Flaeche_bef_Dim_Ist','flaeche_bef_dim_ist','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Entlastungsfracht_NH4_N_optimiert','entlastungsfracht_nh4_n_optimiert1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Einwohner_geplant','einwohner_geplant1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Wasserspiegel_Hydraulik','wasserspiegel_hydraulik','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Ueberlaufhaeufigkeit_Ist_optimiert','ueberlaufhaeufigkeit_ist_optimiert1','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Pumpenregime','pumpenregime','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Einwohner_Ist','einwohner_ist1','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Wiederbeschaffungswert','wiederbeschaffungswert','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Entlastungsfracht_NH4_N_optimiert','entlastungsfracht_nh4_n_optimiert','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle.Oberflaechengewaesser','oberflaechengewaesser','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk.Volumen_Pumpensumpf','volumen_pumpensumpf','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK.Steuerung_Fernwirkung','steuerung_fernwirkung','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf.Flaeche_bef_geplant','flaeche_bef_geplant','vsadssmini_sk',NULL);
INSERT INTO vsadssmini_fk.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken.Schmutzabwasseranfall_Ist','schmutzabwasseranfall_ist2','vsadssmini_sk',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Ueberlauf_Foerderaggregat','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Trennbauwerk','ch.ehi.ili2db.inheritance','superClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Leitung_Text','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenrueckhaltebecken_kanal','ch.ehi.ili2db.inheritance','superClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.ALR','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Kennlinie_Stuetzpunkt','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Einleitstelle','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Rohrprofil_Geometrie','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Massnahme_KnotenAssoc','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Knoten','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Uebrige','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Autonome_Messstelle','ch.ehi.ili2db.inheritance','superClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Pumpwerk','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Knoten_Text','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Rohrprofil','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Leitung','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Massnahme_LeitungAssoc','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Massnahme','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlauf','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SIA405_Base_Abwasser_LV95.Administration.Organisation','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Regenueberlaufbecken','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Bauwerkskomponente','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.SK_Duekeroberhaupt','ch.ehi.ili2db.inheritance','superClass');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('VSADSSMINI_2020_LV95.VSADSSMini.Teileinzugsgebiet','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO vsadssmini_fk.vsadssmini_sk_einleitstelle_einfluss_hilfsindikatoren (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'Status_klaeren',4,'Status klaeren','0',NULL);
INSERT INTO vsadssmini_fk.vsadssmini_sk_einleitstelle_einfluss_hilfsindikatoren (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'unbekannt',5,'unbekannt','0',NULL);
INSERT INTO vsadssmini_fk.vsadssmini_sk_einleitstelle_einfluss_hilfsindikatoren (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'unklar',6,'unklar','0',NULL);
...
INSERT INTO vsadssmini_fk.vsadssmini_sk_einleitstelle_handlungsbedarf (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'unbekannt',4,'unbekannt','0',NULL);
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','einwohner_dim_ist2','ch.ehi.ili2db.unit','CountedObjects');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','schmutzabwasseranfall_ist','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsanteil_nh4_n_ist1','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','mehrbelastung_ist2','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','mehrbelastung_ist_optimiert2','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufdauer_geplant','ch.ehi.ili2db.unit','h');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'primaerrichtungref','ch.ehi.ili2db.foreignKey','vsadssmini_knoten');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','wasserspiegel_hydraulik','ch.ehi.ili2db.unit','m');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'bueroref','ch.ehi.ili2db.foreignKey','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','einwohner_ist1','ch.ehi.ili2db.unit','CountedObjects');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','qan_ist1','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'ausfuehrende_firmaref','ch.ehi.ili2db.foreignKey','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','stauraum3','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','fremdwasseranfall_geplant2','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_geplant1','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','foerderstrommin','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','fremdwasseranfall_geplant','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufdauer_geplant1','ch.ehi.ili2db.unit','h');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','stauraum4','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_red_dim_geplant','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','nutzinhalt_fangteil','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','stauraum','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','qab_geplant','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','mehrbelastung_geplant','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufdauer_ist_optimiert','ch.ehi.ili2db.unit','h');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','auslaufrohr_lichte_hoehe','ch.ehi.ili2db.unit','mm');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_bef_ist1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','q347','ch.ehi.ili2db.unit','m3s');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'datenlieferantref','ch.ehi.ili2db.foreignKey','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','einwohner_dim_geplant','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_teileinzugsgebiet',NULL,'sbw_sw_istref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_trennbauwerkref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_red_geplant1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_dim_geplant1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsanteil_nh4_n_geplant1','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_red_ist','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','foerderhoehe_geodaetisch','ch.ehi.ili2db.unit','m');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','schmutzabwasseranfall_ist2','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsfracht_nh4_n_geplant','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufmenge_ist1','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'naechstes_sbwref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsfracht_nh4_n_optimiert1','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','foerderstrommax','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','einwohner_dim_geplant2','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_dim_geplant2','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','aggregatezahl','ch.ehi.ili2db.unit','CountedObjects');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'einleitstelleref1','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','mehrbelastung_ist_optimiert1','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','mehrbelastung_geplant2','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','qab_ist','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_bef_dim_geplant2','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufmenge_ist_optimiert1','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','fremdwasseranfall_ist1','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsfracht_nh4_n_optimiert','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'T_Type','ch.ehi.ili2db.types','["vsadssmini_sk_autonome_messstelle","vsadssmini_sk_duekeroberhaupt","vsadssmini_sk_einleitstelle","vsadssmini_sk_pumpwerk","vsadssmini_sk_regenrueckhaltebecken_kanal","vsadssmini_sk_regenueberlauf","vsadssmini_sk_regenueberlaufbecken","vsadssmini_sk_trennbauwerk","vsadssmini_sk_uebrige"]');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'standortgemeinderef','ch.ehi.ili2db.foreignKey','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','schmutzabwasseranfall_geplant1','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','einwohner_geplant1','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','einwohner_dim_ist','ch.ehi.ili2db.unit','CountedObjects');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_ist','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','fremdwasseranfall_geplant1','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','qab_ist_optimiert','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_red_dim_geplant2','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_geplant','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','gewaesserspezifische_entlastungsfracht_nh4_n_optimiert','ch.ehi.ili2db.unit','kga');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','qan_ist_optimiert','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufmenge_geplant1','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','gewaesserspezifische_entlastungsfracht_nh4_n_ist','ch.ehi.ili2db.unit','kga');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','einwohner_dim_geplant1','ch.ehi.ili2db.unit','CountedObjects');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_dim_geplant','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_bef_dim_geplant1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_bef_geplant1','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_red_dim_geplant1','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','qan_ist_optimiert2','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_red_dim_ist','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_duekeroberhauptref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','schmutzabwasseranfall_ist1','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_teileinzugsgebiet',NULL,'sbw_rw_geplantref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsanteil_nh4_n_ist','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','fremdwasseranfall_ist','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','nutzinhalt','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_dim_ist','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','mehrbelastung_geplant1','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_pumpwerkref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_bef_geplant','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_bef_ist','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufdauer_ist_optimiert1','ch.ehi.ili2db.unit','h');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_teileinzugsgebiet',NULL,'sbw_sw_geplantref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','stauraum1','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','qan_geplant2','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_red_ist1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_ist1','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','einwohner_dim_ist1','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','fremdwasseranfall_geplant3','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','schmutzabwasseranfall_ist3','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','qan_ist','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','stauraum2','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','qan_geplant1','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsanteil_nh4_n_geplant','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_red_dim_ist1','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','mehrbelastung_ist','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufdauer_ist','ch.ehi.ili2db.unit','h');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'einleitstelleref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','ueberlaufdauer_ist1','ch.ehi.ili2db.unit','h');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_uebrige','beschrieb','ch.ehi.ili2db.textKind','MTEXT');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsfracht_nh4_n_geplant1','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','mehrbelastung_ist_optimiert','ch.ehi.ili2db.unit','Percent');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','flaeche_red_geplant','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_trennbauwerk','qan_ist2','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','einwohner_ist','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufmenge_ist','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','einwohner_geplant','ch.ehi.ili2db.unit','CountedObjects');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsanteil_nh4_n_optimiert','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','schmutzabwasseranfall_geplant2','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','mehrbelastung_ist1','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'datenherrref','ch.ehi.ili2db.foreignKey','administration_organisation');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','fremdwasseranfall_ist2','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_red_dim_ist2','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_regenrueckhaltebecken_kanalref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufmenge_ist_optimiert','ch.ehi.ili2db.unit','m3');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_dim_ist2','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','schmutzabwasseranfall_geplant','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','qan_ist_optimiert1','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'wiederbeschaffungswert','ch.ehi.ili2db.unit','CHF');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_bef_dim_geplant','ch.ehi.ili2db.unit','ha');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_regenueberlaufbeckenref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_bauwerkskomponente',NULL,'stammkarteref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_einleitstelle','gewaesserspezifische_entlastungsfracht_nh4_n_geplant','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','schmutzabwasseranfall_geplant3','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','nutzinhalt_klaerteil','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsfracht_nh4_n_ist1','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_dim_ist1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_kennlinie_stuetzpunkt',NULL,'sk_regenueberlaufref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','entlastungsanteil_nh4_n_optimiert1','ch.ehi.ili2db.unit','Percent');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','volumen_pumpensumpf','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','flaeche_bef_dim_ist2','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','entlastungsfracht_nh4_n_ist','ch.ehi.ili2db.unit','kga');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenrueckhaltebecken_kanal','fremdwasseranfall_ist3','ch.ehi.ili2db.unit','ls');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'akten','ch.ehi.ili2db.textKind','MTEXT');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','qan_geplant','ch.ehi.ili2db.unit','ls');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlauf','ueberlaufmenge_geplant','ch.ehi.ili2db.unit','m3');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'hauptbauwerkref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk',NULL,'paa_knotenref','ch.ehi.ili2db.foreignKey','vsadssmini_knoten');
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_pumpwerk','flaeche_bef_dim_ist','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_sk','vsadssmini_sk_regenueberlaufbecken','flaeche_bef_dim_ist1','ch.ehi.ili2db.unit','ha');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('vsadssmini_teileinzugsgebiet',NULL,'sbw_rw_istref','ch.ehi.ili2db.foreignKey','vsadssmini_sk');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('vsadssmini_sk','ch.ehi.ili2db.tableKind','CLASS');
...
END Base_LV95.','2020-11-07 17:11:41.885');
...
','2020-11-07 17:11:41.885');
INSERT INTO vsadssmini_fk.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('VSADSSMINI_2020_2_d_LV95-20201029.ili','2.3','VSADSSMINI_2020_LV95{ Units INTERLIS Base_LV95 SIA405_Base_Abwasser_LV95}','!!@ comment = "VSADSSMINI_2020_2_d_LV95.ili"
...
INSERT INTO vsadssmini_fk.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.interlis.ili2c.ilidirs','https://vsa.ch/models;http://models.geo.admin.ch');
...
INSERT INTO vsadssmini_fk.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.inheritanceTrafo','smart1');
